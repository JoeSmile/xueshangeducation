...
export const OffersCountry: OffersCountryType = {
  ...
  "USA": [
    ...
    {
      logoUrl: '/contry_school/USA/11.png',
      schoolName: '圣路易斯华盛顿大学硕士',
      name: 'S同学',
      graduateFrom: '齐鲁工业大学英语专业',
      subject: '托福 81 / GPA3.13',
    },
    {
      logoUrl: '/contry_school/USA/9.png',
      schoolName: '南加州大学供应链硕士',
      name: 'M同学',
      graduateFrom: '山东大学物流专业',
      subject: 'TOEFL：99 / GPA3.85/5.0',
    },
    {
      logoUrl: '/contry_school/USA/11.png',
      schoolName: '圣路易斯华盛顿大学硕士',
      name: 'A同学',
      graduateFrom: '黑龙江大学法律专业',
      subject: 'GPA 83 / IELTS：7',
    },
    {
      logoUrl: '/contry_school/USA/15.png',
      schoolName: '俄勒冈州立大学土木工程专业硕士',
      name: 'S同学',
      graduateFrom: '济南大学土木工程',
      subject: '经济学/均分：87/托福105/GRE:320+',
    },
  ],
  "Canada": [
