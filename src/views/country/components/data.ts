...
export const OffersCountry: OffersCountryType = {
  "UK": [
    {
      logoUrl: '/contry_school/UK/1_.png',
      schoolName: '伦敦政治经济学院录取',
      name: 'J同学',
      graduateFrom: '985院校',
      subject: '经济学/均分：87/雅思 7/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/2_.png',
      schoolName: '伦敦大学学院录取',
      name: 'W同学',
      graduateFrom: '211院校',
      subject: '应用心理学/均分：88+/雅思 7/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/3_.png',
      schoolName: '英国爱丁堡大学录取',
      name: 'Y同学',
      graduateFrom: '211院校',
      subject: '经济学/均分：86+/雅思 7/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/4_.png',
      schoolName: '曼彻斯特大学录取',
      name: 'Z同学',
      graduateFrom: '211院校',
      subject: '会计/均分：85+/PTE 66/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/5_.png',
      schoolName: '布里斯托大学录取',
      name: 'L同学',
      graduateFrom: '211院校',
      subject: '电子信息工程均分80/无语言成绩/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/6_.png',
      schoolName: '伯明翰大学录取',
      name: 'K同学',
      graduateFrom: '独立院校',
      subject: '均分85+/无语言成绩/无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/UK/7_.png',
      schoolName: '英国爱丁堡大学录取',
      name: 'L同学',
      graduateFrom: '双非二本',
      subject: '均分89 /无雅思录取',
    }, {
      logoUrl: '/contry_school/UK/8_.png',
      schoolName: '伦敦大学录取',
      name: 'X同学',
      graduateFrom: '华南理工',
      subject: '化学工程/GPA:90.6% /雅思6',
    }
  ],
  "USA": [
    {
      ...
      logoUrl: '/contry_school/USA/4_.png',
      schoolName: '东北大学录取',
      name: 'L同学',
      graduateFrom: '奥本大学',
      subject: '戏剧专业/均分85+',
    }, {
      logoUrl: '/contry_school/USA/5_.png',
      schoolName: '东北大学录取',
      name: 'M同学',
      graduateFrom: '奥本大学',
      subject: '戏剧专业/均分：2.76',
    }, {
      logoUrl: '/contry_school/USA/6_.png',
      schoolName: '阿拉巴马伯明翰大学录取',
      name: 'L同学',
      graduateFrom: '齐鲁工业大学',
      subject: '英语专业/托福81/GPA3.13',
    }, {
      logoUrl: '/contry_school/USA/7_.png',
      schoolName: '南加州大学录取',
      name: 'M同学',
      graduateFrom: '山东大学',
      subject: '物流专业/GPA3.85/5.0',
    }, {
      logoUrl: '/contry_school/USA/8_.png',
      schoolName: '俄勒冈州立大学录取',
      name: 'C同学',
      graduateFrom: '济南大学',
      subject: '土木工程/托福69 /GPA3',
    },
  ],
  "Canada": [
    {
    ...
    {
      logoUrl: '/contry_school/canada/4.png',
      schoolName: '麦克马斯特大学录取',
      name: 'X同学',
      graduateFrom: '南京信息工程大学',
      subject: '计算机/GPA3.7/托福106',
      basicInfo: '成功录取BC省排名靠前的本拿比山高中',
    },
    {
      logoUrl: '/contry_school/canada/11.png',
      schoolName: '西安大略大学录取',
      name: 'C同学',
      graduateFrom: '海南大学',
      subject: '数学和应用数学/ GPA3.5+/雅思7 /GRE310+ ',
      basicInfo: '卡尔加里大学',
    },
    {
      logoUrl: '/contry_school/canada/10.png',
      schoolName: '卡尔顿大学录取',
      name: 'F同学',
      graduateFrom: '河南大学/研究生美国福特汉姆大学',
      subject: '商业分析专业/GPA都在3.5+/无雅思录取',
      basicInfo: '',
    }, {
      logoUrl: '/contry_school/canada/2.png',
      schoolName: '多伦多大学录取',
      name: 'B同学',
      graduateFrom: '加拿大西三一大学',
      subject: '领导力/GPA 3.2/ GMAT online 700分',
      basicInfo: '',
    }, {
      logoUrl: '/contry_school/canada/7.png',
      schoolName: '渥太华大学传播学录取',
      name: 'L同学',
      graduateFrom: '美国俄亥俄州立大学',
      subject: '新闻学/GPA：3.36/无G',
      basicInfo: '',
    }        
  ...
  "Australia": [
    ...
    },
    {
      ...
      logoUrl: '/contry_school/Australia/11.png',
      schoolName: '澳国立大学录取',
      name: 'M同学',
      graduateFrom: '211院校',
      subject: '计算机专业/均分80 ',
  ...
  "HonKong": [
    {
      ...
      schoolName: '港中文大学',
      name: 'Y同学',
      graduateFrom: '国内211院校',
      subject: '工商管理/均分85+/雅思 7',
    }, {
      logoUrl: '/contry_school/HonKong/2.png',
      schoolName: '港中文大学',
      name: 'Z同学',
      graduateFrom: '国内211院校',
      subject: '法律/雅思 6.5/均分：87',
    }, {
      logoUrl: '/contry_school/HonKong/1.png',
      schoolName: '港大录取',
      name: 'S同学',
      graduateFrom: '国内211院校',
      subject: '信息系统管理/均分：87+/雅思7  /无GRE，GMAT',
    }, {
      logoUrl: '/contry_school/HonKong/3.png',
      schoolName: '香港科技大学案例',
      name: 'F同学',
      ...
      name: 'W同学',
      graduateFrom: '985院校',
      subject: '均分80+ /雅思6.5 /有一定工作经验',
    }, {
      logoUrl: '/contry_school/HonKong/2.png',
      schoolName: '港中文大学',
      name: 'L同学',
      graduateFrom: '武理工',
      subject: '电子信息均分 83/雅思7.0',
    }, {
      logoUrl: '/contry_school/HonKong/1.png',
      schoolName: '香港大学录取',
      name: 'K同学',
      graduateFrom: '武理工',
      subject: '交通运输/均分 83/雅思7.0',
    },
  ],
  "Singapore": [
    {
